...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center pt-[80px] overflow-hidden bg-gradient-mesh" aria-labelledby="hero-title">
      <div className="absolute inset-0" aria-hidden="true">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_20%_0%,rgba(80,160,255,0.08)_0%,transparent_60%)]" />
        <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(ellipse_at_80%_10%,rgba(24,199,161,0.06)_0%,transparent_50%)]" />
      </div>
          ...
          <div className="lg:pr-8">
            <StaggerContainer baseDelay={100} staggerDelay={100}>
              <ScrollReveal delay={0}>
                <span className="inline-block px-4 py-2 text-caption font-medium tracking-widest uppercase text-accent bg-accent-soft rounded-pill mb-6">
              ...
              <ScrollReveal delay={100}>
                <h1
                  id="hero-title"
                  className="text-hero font-bold tracking-[-0.03em] leading-[0.95] text-text max-w-text"
              ...
              <ScrollReveal delay={200}>
                <p className="mt-[24px] text-body-lg text-text-muted max-w-text leading-relaxed">
                  We build AI systems that automate the work your team shouldn&apos;t be doing manually.
                </p>
              </ScrollReveal>
              <ScrollReveal delay={300}>
                <p className="mt-6 text-body text-text-muted max-w-text leading-relaxed">
              ...
              <ScrollReveal delay={500}>
                <div className="mt-16 flex flex-wrap items-center gap-6 text-body-sm text-text-light">
