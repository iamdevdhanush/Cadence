...
export function ConnectionLines({
  ...
  const getNodeColor = (type: Node['type']) => {
    switch (type) {
      case 'input':
        return 'rgba(99, 240, 200, 0.6)'
      case 'core':
        return '#63F0C8'
      case 'output':
        return 'rgba(99, 240, 200, 0.8)'
      default:
      ...
      >
        <defs>
          <linearGradient id="coreGlow" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="100%" stopColor="#63F0C8" stopOpacity="0" />
          </linearGradient>
        ...
        {connections.map((conn, index) => {
          ...
          return (
            <path
              key={index}
              d={path}
              stroke={isFromCore || isToCore ? '#63F0C8' : 'rgba(99, 240, 200, 0.4)'}
              ...
              style={{
                opacity: animate ? 0 : 1,
                filter: isFromCore || isToCore ? 'drop-shadow(0 0 4px #63F0C8)' : 'none',
